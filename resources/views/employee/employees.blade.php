...
<div class="header-container" style="margin-bottom: 5px;">
    ...
    <a href="/download-filter?<?php echo $_SERVER['QUERY_STRING'] ?>" class="btn btn-info" >
    ...
    <ul class="alphabet-search" style="padding-left: 0px">
        ...
        <!-- <li><a href="/download-filter?<?php echo $_SERVER['QUERY_STRING'] ?>" class="btn btn-default" style="margin: 0px; height: 30px;">Download Results</a></li> -->
    </ul>
